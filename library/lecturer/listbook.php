                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php 
$sql="SELECT tblbook.Title, tblbook.id, tbllecturers.FullName, tblbook.Location,tblbook.Borrowers, tblbook.Availability from tblbook join tbllecturers on tbllecturers.id=tblbook.LecturesID";
$query = $dbh -> prepare($sql);
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php if($result->Availability=="1")
                                            {?>
                                            ...
                                            <td class="center">
                                            <a href="borrowsbook.php?bookid=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Borrow</button> 
